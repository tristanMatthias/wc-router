...
var _createBrowserHistory = __webpack_require__(0);
        ...
        value: function _handleChange(location) {
            ...
            Object.entries(this.routes).forEach(function (_ref) {
                ...
                if (match) {
                    ...
                    return r.isConnected ? r.parentNode.removeChild(r) : r;
                });
            });
        }
    }, {
...
__webpack_require__(26)(IteratorPrototype, __webpack_require__(16)('iterator'), function () { return this; });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(36)(Function.call, __webpack_require__(66).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
